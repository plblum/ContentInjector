...
namespace InsertionsManagement
{
   ...
   /// </summary>
   public class IMRazorViewEngine : RazorViewEngine
   {
      public IMRazorViewEngine()
         : base()
      {
      }

      public IMRazorViewEngine(IViewPageActivator viewPageActivator)
      ...
      {
         return new IMRazorView(controllerContext, partialPath,
      ...
      {
         var view = new IMRazorView(controllerContext, viewPath,
