...
{
/// <summary>
/// Classes supported by InsertionManager must implement this.
...
/// based on IInserter. The interface is used to request the class through a
/// the InsertionsServices class. It allows switching implementations as needed.</para>
/// <para>The consumer of InsertionManager passes the appropriate interface
/// to InsertionManager.Access[T] where T is the interface.</para>
/// </remarks>
