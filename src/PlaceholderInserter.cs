...
/// In this case, there is usually just one PlaceholderInserterItem defined
/// per PlaceholderInserter instance.
/// </para>
/// </remarks>
   public class PlaceholderInserter : BaseKeyedInserter<PlaceholderInserterItem>, IPlaceholderInserter
   {
#if false
      ...
      public override string GetContent(HttpContextBase httpContext)
      {
         ...
         {
            foreach (PlaceholderInserterItem items in orders.Value)
            {
      ...
      protected override void ItemContent(PlaceholderInserterItem item, StringBuilder sb, HttpContextBase httpContext)
      {
...
/// <param name="order"></param>
      ...
      {
         Add(new PlaceholderInserterItem(content), order);
